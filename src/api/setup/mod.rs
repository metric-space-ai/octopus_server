use crate::{
    ...
    context::Context,
    entity::{
        WorkspacesType, PARAMETER_NAME_AZURE_OPENAI_API_KEY,
        PARAMETER_NAME_AZURE_OPENAI_DEPLOYMENT_ID, PARAMETER_NAME_AZURE_OPENAI_ENABLED,
        PARAMETER_NAME_OCTOPUS_API_URL, PARAMETER_NAME_OPENAI_API_KEY,
