...
pub async fn update(
    ...
    let workspace = context
        .octopus_database
        .update_workspace(id, &input.name, input.r#type)
        .await?;
...
pub mod tests {
    ...
    async fn create_201_public() {
        ...
        let workspace = workspace_create(third_router, session_id, user_id, &name, r#type).await;
    ...
    async fn create_201_private() {
        ...
        let workspace = workspace_create(fourth_router, session_id, user2_id, &name, r#type).await;
        let workspace_id = workspace.id;
    ...
    async fn read_403_public() {
        ...
        let user =
            api::setup::tests::setup_post(fourth_router, &company_name, &email, password).await;
