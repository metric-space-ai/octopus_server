...
mod tests {
    ...
    pub async fn nextcloud_files_create(router: Router, session_id: Uuid) -> String {
        let body =
        ...
        let request = Request::builder()
            ...
            .uri("/api/v1/nextcloud-raw-files")
    ...
    async fn create_201() {
        ...
        nextcloud_files_create(router, session_id).await;
    ...
    async fn list_200() {
        ...
        nextcloud_files_create(router.clone(), session_id).await;

        let response = router
            .oneshot(
                Request::builder()
                    .method(http::Method::GET)
                    .uri("/api/v1/nextcloud-raw-files".to_string())
